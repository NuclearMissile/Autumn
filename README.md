...
ls                     # current path: xxx/autumn
cp ./hello-autumn/target/hello-autumn-1.0.3.war ./autumn-core/target/hello-autumn-1.0.3.war
cd ./autumn-core/target/
# execute hello-autumn-1.0.3.war with homemade http server in autumn-core
java -jar autumn-core-1.0.3.jar -w hello-autumn-1.0.3.war
