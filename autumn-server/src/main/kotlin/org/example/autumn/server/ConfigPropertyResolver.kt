...
import org.example.autumn.server.utils.ClassPathUtils
import org.example.autumn.server.utils.ConfigUtils.loadYamlAsPlainMap
...
class ConfigPropertyResolver(props: Properties) : PropertyResolver {
    companion object {
        ...
        private const val CONFIG_APP_YAML: String = "/server.yml"
        private const val CONFIG_APP_PROP: String = "/server.properties"

        /**
         * Try load property resolver from /server.yml or /server.properties.
         */
